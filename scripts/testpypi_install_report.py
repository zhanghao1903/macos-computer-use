...
PACKAGE_SMOKE_SNIPPETS = {
    ...
    "computer-use-macos": (
        ...
        "observe_command, open_app_command, focus_app_command, click_command, "
    ...
    "wechat-desktop-tool": (
        ...
        "focus_contact_command, observe_current_chat_command, "
        "read_visible_messages_command, draft_message_command, "
        ...
        "read_visible_messages_command(limit=5), draft_message_command('hello'), "
