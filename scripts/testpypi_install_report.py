...
PACKAGE_SMOKE_SNIPPETS = {
    ...
    "computer-use-macos": (
        ...
        "ACCESSIBILITY_QUERY_TARGET_APP_NOT_FRONTMOST, TARGET_APP_NOT_FRONTMOST, "
        ...
        "assert {ACCESSIBILITY_QUERY_TARGET_APP_NOT_FRONTMOST, "
        "TARGET_APP_NOT_FRONTMOST, ACCESSIBILITY_TREE_TARGET_APP_NOT_FRONTMOST} "
    ...
    "wechat-desktop-tool": (
        ...
        "send_message, WECHAT_FAILURE_KINDS, WECHAT_AGENT_SKILL_SCHEMA, "
        "WECHAT_USE_SKILL_NAME, WeChatAgentSkill, load_wechat_use_skill\n"
        ...
        "agent_skill = load_wechat_use_skill()\n"
        "assert isinstance(agent_skill, WeChatAgentSkill)\n"
        "assert agent_skill.schema == WECHAT_AGENT_SKILL_SCHEMA\n"
        "assert agent_skill.name == WECHAT_USE_SKILL_NAME\n"
        "assert agent_skill.version == '1.0.0'\n"
        "assert agent_skill.entrypoint == 'SKILL.md'\n"
        "assert 'send_message' in agent_skill.instructions\n"
        "assert agent_skill.get_file('references/recovery.md').content\n"
